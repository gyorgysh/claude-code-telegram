...
src/
  ...
  core/               telegraf-free layer shared by all agents and the panel
    ...
    connectors.ts     external-connector catalog (Notion, GCal, Gmail, Drive, Apple Cal/Mail, Slack, GitHub) + read/write scope
